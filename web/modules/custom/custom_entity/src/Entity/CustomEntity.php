 ...
 *   },
 *   links = {
 *     "add-form" = "/admin/content/custom-entity/add/{custom_entity_type}",
 *     "add-page" = "/admin/content/custom-entity/add",
 *     "canonical" = "/custom_entity/{custom_entity}",
 *     "edit-form" = "/admin/content/custom-entity/{custom_entity}/edit",
 *     "delete-form" = "/admin/content/custom-entity/{custom_entity}/delete",
...
class CustomEntity extends ContentEntityBase implements CustomEntityInterface {
   ...
   * {@inheritdoc}
   *
   * When a new custom entity entity is created, set the uid entity reference to
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['title'] = BaseFieldDefinition::create('string')
      ...
      ->setLabel(t('Title'))
      ->setDescription(t('The title of the custom entity entity.'))
      ->setRequired(TRUE)
    ...
    $fields['status'] = BaseFieldDefinition::create('boolean')
      ->setLabel(t('Status'))
      ->setDescription(t('A boolean indicating whether the custom entity is enabled.'))
    ...
    $fields['description'] = BaseFieldDefinition::create('text_long')
      ...
      ->setDescription(t('A description of the custom entity.'))
      ->setDisplayOptions('form', [
        'type' => 'text_textarea',
        'weight' => 10,
      ])
    ...
    $fields['uid'] = BaseFieldDefinition::create('entity_reference')
      ->setTranslatable(TRUE)
      ->setLabel(t('Author'))
      ->setDescription(t('The user ID of the custom entity author.'))
